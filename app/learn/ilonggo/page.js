...
const AUDIO = {
  ...
  "Maayong aga sa inyo": "fix_079_maayong_aga_kamo.mp3",
  "Maayong hapon": "new_il_gr_maayong_hapon.mp3",
  "Maayong hapon sa inyo": "new_il_gr_maayong_hapon_inyo.mp3",
  "Maayong gab-i": "new_il_gr_maayong_gabi.mp3",
  "Maayong gab-i sa inyo": "new_il_gr_maayong_gabi_inyo.mp3",
  ...
  "Buligi ko palihog": "new_il_custom_buligi_ko_palihog.mp3",
  "Hulat anay": "new_il_custom_hulat_anay.mp3",
  "Lakat ta": "new_il_custom_lakat_ta.mp3",
  "Ari ko": "new_il_custom_ari_ko.mp3",
  "Dali lang": "new_il_custom_dali_lang.mp3",
  "Didto siya": "new_il_custom_didto_siya.mp3",
  "Ano Oras na?": "new_il_custom_ano_oras_na.mp3",
  "Budlay ini": "new_il_custom_budlay_ini.mp3",
  "Balik lang": "new_il_custom_balik_lang.mp3",
  "Kitaay ta liwat": "new_il_custom_kitaay_ta_liwat.mp3",
  "Malakat nako": "new_il_custom_malakat_nako.mp3",
  "Halong ka": "new_il_custom_halong_ka.mp3",
  "Taga diin ka?": "new_il_custom_taga_diin_ka.mp3",
  "Gahod": "new_il_custom_gahod.mp3",
  "Diin ka makadto?": "new_il_custom_diin_ka_makadto.mp3",
  "Akon": "new_il_custom_akon.mp3",
  "Aton": "new_il_custom_aton.mp3",
  "Ano Oras": "new_il_custom_ano_oras.mp3",
  "Pwede ka hulam?": "new_il_custom_pwede_ka_hulam.mp3",
  "Ka init subong": "new_il_custom_ka_init_subong.mp3",
  "Ka tugnaw subong": "new_il_custom_ka_tugnaw_subong.mp3",
  "Ka tam-is sini": "new_il_custom_ka_tam-is_sini.mp3",
  "Gasakit ulo ko": "new_il_custom_gasakit_ulo_ko.mp3",
  "Ka parat sini": "new_il_custom_ka_parat_sini.mp3",
  "Ka pait sini": "new_il_custom_ka_pait_sini.mp3",
  "Ka aslom sini": "new_il_custom_ka_aslom_sini.mp3",
  "Kahang Mani ni": "new_il_custom_kahang_mani_ni.mp3",
  "Namit ni": "new_il_custom_namit_ni.mp3",
  "Wala Mani sabor": "new_il_custom_wala_mani_sabor.mp3",
};
...
const LESSONS = {
  ...
  advanced: [
    ...
    { id: "il-a4", title: "IV. Common Phrases", icon: "🗨️", hasFormal: false, rows: [
      ["Buligi ko palihog","Please, help me"],
      ["Hulat anay","Wait a moment"],
      ["Lakat ta","Let's go"],
      ["Ari ko","I'm here"],
      ["Dali lang","Just a moment"],
      ["Didto siya","He/she is there"],
      ["Ano Oras na?","What time is it?"],
      ["Budlay ini","This is difficult"],
      ["Balik lang","Come back again"],
      ...
      ["Akon","Mine"],
      ["Aton","Our"],
      ["Pwede ka hulam?","Can I borrow?"],
    ]},
    { id: "il-a5", title: "V. Taste & Weather", icon: "🌶️", hasFormal: false, rows: [
      ["Ka init subong","It's hot today"],
      ["Ka tugnaw subong","It's cold today"],
      ["Ka tam-is sini","This is sweet"],
      ["Gasakit ulo ko","I have a headache"],
      ["Ka parat sini","This is salty"],
      ["Ka pait sini","This is bitter"],
      ["Ka aslom sini","This is sour"],
      ["Kahang Mani ni","This is spicy"],
      ["Namit ni","This is delicious"],
      ["Wala Mani sabor","This is tasteless"],
    ]},
  ],
};
...
function FormalTable({ lesson }) {
  ...
  const toggleLabel = lesson.toggleLabel || "plural";
  const col2Label = lesson.col2Label || "Plural";

  return (
    <>
      <style>{`
        .formal-col-il { display: table-cell; }
        .kamo-toggle-col-il { display: none; }
        @media (max-width: 600px) {
          .formal-col-il { display: none; }
          .kamo-toggle-col-il { display: table-cell; }
        }
      `}</style>
      <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.9rem" }}>
        <thead>
          <tr style={{ background: "rgba(255,255,255,0.05)" }}>
            <th style={th}>Singular (ka)</th>
            <th className="formal-col-il" style={th}>{col2Label}</th>
            <th className="kamo-toggle-col-il" style={{ ...th, textAlign: "center" }}>{toggleLabel}</th>
            <th style={th}>English</th>
          </tr>
        </thead>
        <tbody>
          {lesson.rows.map((row, i) => {
            const hasPlural = row[1] && row[1] !== "—";
            return (
              <>
                <tr key={i} style={{ borderBottom: expandedRows[i] ? "none" : "1px solid rgba(255,255,255,0.05)" }}>
                  ...
                  <td className="formal-col-il" style={{ ...td, color: "#86efac" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                      {row[1]}
                      {hasPlural && AUDIO[row[1]] && (
                        <button onClick={() => playAudio(row[1])} style={speakBtn}>🔊</button>
                      )}
                    </div>
                  </td>
                  <td className="kamo-toggle-col-il" style={{ ...td, textAlign: "center", verticalAlign: "middle" }}>
                    {hasPlural && (
                      <button
                        onClick={() => toggleRow(i)}
                        style={{
                ...
                {expandedRows[i] && hasPlural && (
                  <tr key={`${i}-plural`} style={{ borderBottom: "1px solid rgba(255,255,255,0.05)", background: "rgba(134,239,172,0.05)" }}>
